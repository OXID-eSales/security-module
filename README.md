...
[![Development](https://github.com/OXID-eSales/security-module/actions/workflows/trigger.yaml/badge.svg?branch=b-7.6.x)](https://github.com/OXID-eSales/security-module/actions/workflows/trigger.yaml)
...
This module assumes you have OXID eShop Compilation version 7.6.0 installed.

### Branches
* 4.1.0.x versions (or b-7.6.x branch) are compatible with OXID eShop compilation 7.6.x
...
```shell
git clone --recurse-submodules https://github.com/OXID-eSales/security-module.git --branch=b-7.6.x ./source
```
